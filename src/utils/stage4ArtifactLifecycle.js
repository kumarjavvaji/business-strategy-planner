...
export function createArtifactChildUnit(childDef, patch = {}) {
  ...
  return {
    ...
    atomType:        childDef?.atomType        || patch.atomType        || null,
    inputBasis:      childDef?.inputBasis      || patch.inputBasis      || null,
    isStaticAtom:    childDef?.isStaticAtom    ?? patch.isStaticAtom    ?? false,
    sourceAtomRefs:  childDef?.sourceAtomRefs  || patch.sourceAtomRefs  || [],
